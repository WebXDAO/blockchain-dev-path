...
[![License](https://img.shields.io/github/license/web3community/blockchain-dev-path)](https://img.shields.io/github/license/web3community/blockchain-dev-path)
...
Since the new GitHub Issue forms we only suggest you to include most information possible. But you can also **Perform a [cursory search](https://github.com/web3community/blockchain-dev-path/issues)** to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
- [Beginner issues](https://github.com/web3community/blockchain-dev-path/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22) - issues which should only require a few lines of code, and a test or two.
- [Help wanted issues](https://github.com/web3community/blockchain-dev-path/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) - issues which should be a bit more involved than `beginner` issues.
...
Please follow all instructions in [the template](https://github.com/web3community/blockchain-dev-path/blob/main/.github/pull_request_template.md)
...
- Reference [issues](https://github.com/web3community/blockchain-dev-path/issues) and [pull requests](https://github.com/web3community/blockchain-dev-path/pulls) liberally after the first line.
- Follow the [conventional commits](https://www.conventionalcommits.org/en/v1.0.0/) guidelines

## How to Contribute 🚀

- Please create an [issue](https://github.com/web3community/blockchain-dev-path/issues) before creating a pull request.
...
**1.** Fork [this](https://github.com/web3community/blockchain-dev-path) repository. Click on the <a  href="https://github.com/web3community/blockchain-dev-path"><img  src="https://img.icons8.com/fluency/30/000000/code-fork.png"/></a> symbol at the top right corner.
